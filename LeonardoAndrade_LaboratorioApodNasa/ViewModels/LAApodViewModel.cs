...
using LeonardoAndrade_LaboratorioApodNasa.Services;
using System;
...
namespace LeonardoAndrade_LaboratorioApodNasa.ViewModels
{
    public class LAApodViewModel : INotifyPropertyChanged
    {
        ...
        private ApodServiceLA service;
        public ApodServiceLA Service
        {
            get
            {
                if (service == null)
                {
                    service = new ApodServiceLA();
                }
                return service;
            }
        }
        ...
        {
            LAApod dto = await Service.GetImage(day);
            if (dto == null)
            {
